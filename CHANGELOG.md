...
- Added Context Pack Handoff Runtime v1.11 aggregate release summary and closure checklist.
- Closed Context Pack Handoff Runtime v1.11 with final release notes and closure checklist.
...
- Added Operator Workflow Execution Controls package start.
...
- Added memory policy, evaluation checks, output format, safety, handoff, and tool-use standards.
- Added ADR 0015 for AI Agents v0.4 start.
- Added ADR 0016 and release checklist for AI Agents completion.
- Added AI release requirement validation.
...
- Added governance, standards, roadmap, agent, product, design, architecture, and infrastructure documentation areas.
- Added GitHub collaboration templates and baseline project metadata.
